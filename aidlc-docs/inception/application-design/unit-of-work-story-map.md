...
| NFR-6 — Property-Based Testing | Unit 4 (`ac()`/`cfe()` round-trip, MAD invariants) and Unit 3 (GISIC normalization bounds invariant); oracle-style tests especially relevant to Unit 5 (refactored vs. pre-refactor MCMC/likelihood functions) |
